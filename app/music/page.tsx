...
export default function MusicPage() {
  ...
  return (
    <div className="p-6 xl:p-8 w-full">
      <div className="pt-6 xl:pt-6 flex flex-col items-center">
        <div className="flex flex-col space-y-6 mb-8 w-full max-w-4xl">
          <div className="flex items-center justify-start gap-4">
            <div {...getRootProps()} className="relative cursor-pointer">
              <input {...getInputProps()} />
              <button 
                className={`flex items-center justify-center gap-2 bg-[#5564ff] text-white rounded-xl py-2 px-4 hover:bg-[#5564ff]/90 transition-colors text-sm dark:bg-[#fafafa] dark:hover:bg-[#fafafa]/90 dark:text-[#0a0a0c] ${
                ...
                .map(([filename]) => (
                  <div key={filename} className="bg-white dark:bg-[#0a0a0c] rounded-xl p-4 mb-4 flex items-center gap-4">
                    <div className="relative w-6 h-6">
                      <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#f8d4eb] via-[#ce7acb] to-[#e9bcba] animate-spin"></div>
                      <div className="absolute inset-[2px] rounded-full bg-white dark:bg-[#0a0a0c]"></div>
                    </div>
                    <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4">
                {selectedSongs.map((song) => (
                  <div key={song.id} className="flex flex-col">
                    <div className="group relative aspect-square rounded-t-3xl bg-[#1a1a1a] overflow-hidden">
                        ...
                        <>
                          ...
                          <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button 
                              ...
                              className="absolute top-2 left-2 w-8 h-8 rounded-full bg-[#5564ff] hover:bg-[#5564ff]/90 transition-colors flex items-center justify-center text-white z-20"
                            >
                    ...
                    <div className="p-2 bg-[#0a0a0c] dark:bg-[#fafafa] rounded-b-3xl">
                      <p className="text-sm font-medium text-[#fafafa] dark:text-gray-900 truncate text-center">{song.title || 'Untitled'}</p>
                      <p className="text-xs text-gray-300 dark:text-gray-600 truncate text-center">{song.artist || 'Unknown artist'}</p>
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-1 text-center">{formatDuration(song.duration)}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5564ff] bg-white dark:bg-[#18181A] text-gray-900 dark:text-white"
                />
              </div>
